// import MockedChangelog from "./changelog.js";
...
//       it(`${input} -> ${expected}`, () => {
//         const changelog = new MockedChangelog({repo: "foo/bar", rootPath: "./", cacheDir: ".changelog", labels: {}, ignoreCommitters: [], nextVersion: "Unreleased" });
